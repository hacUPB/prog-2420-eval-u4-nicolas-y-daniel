...
from Listar_archivos.listar_archivos import *
from Funciones_txt.Funciones_txt import *
from Funciones_csv.Funciones_csv import *
        ...
        if opcion == "1":
            ...
            while True:
                ...
                if opcion_txt == "1":
                    ...
                    txt = input("Ingrese la ruta del archivo de texto: ")
                    txt = txt.strip('"')
                    palabra_a_buscar = input("Ingrese la palabra que desea modificar (tal y como está escrita en el texto): ")
            ...
            while True:
                ...
                if opcion_csv == "1":
                    ...
                    csv = input("Ingrese la ruta del archivo CSV: ")
                    csv = csv.strip('"')
                    delimitador = input("Ingrese únicamente el caracter que separa los datos: ")
                    nombre_columna = input("Ingrese el nombre de la columna: ")
                    estadisticas_columna(csv, delimitador, nombre_columna)
                    ...
                    delimitador = input("Ingrese únicamente el caracter que separa los datos: ")
                    nombre_columna = input("Ingrese el nombre de la columna: ")
                    graficar_columna(csv, delimitador, nombre_columna)
